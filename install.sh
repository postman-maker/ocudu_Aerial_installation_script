...
# OCUDU CU (ocu) - CU-CP + CU-UP. Generated by install.sh.
cu_cp:
  amf:
    addr: ${AMF_ADDR}            # AMF N2 address (5G core, reached over NG: ${NG_IFNAME})
    bind_addr: ${NG_LOCAL_IP}    # local NG IP for N2/NGAP traffic
...
cu_up:
  ...
  gtpu:
    bind_addr: ${NG_LOCAL_IP}    # N3 / GTP-U toward the UPF over NG
EOF
